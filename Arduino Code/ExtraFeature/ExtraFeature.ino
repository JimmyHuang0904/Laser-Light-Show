...
// Bottom Motor PID
PID bottomPID(&Input, &Output, &Setpoint, 75, 0.2, 5, DIRECT); // SampleTime = 15

// Top Motor PID
//PID topPID(&Input1, &Output1, &Setpoint1, 7, 0.002, 0.08, DIRECT);
//PID topPID(&Input1, &Output1, &Setpoint1, 100, 20, 3, DIRECT);
//PID topPID(&Input1, &Output1, &Setpoint1, 720, 100, 8, DIRECT); // SampleTime = 15, 15 samples per period
PID topPID(&Input1, &Output1, &Setpoint1, 2800, 600, 40, DIRECT); // SampleTime = 10, 15 samples per period
